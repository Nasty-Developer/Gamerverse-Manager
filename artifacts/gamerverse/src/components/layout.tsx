            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <span className="font-black text-xl tracking-tight text-white">
                  GAMER<span className="text-primary">VERSE</span>
                </span>
              </Link>
              <p className="text-muted-foreground text-sm max-w-xs mb-6 leading-relaxed">
                The ultimate AI-powered gaming discovery engine. Search,
                compare, and find your next obsession among thousands of titles.
              </p>
              <div className="flex gap-3">
                {[
                  ...
                  <a
                    ...
                    href="#"
                    aria-label={label}
                    className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-white transition-all border border-white/10 hover:border-primary"
                  >
