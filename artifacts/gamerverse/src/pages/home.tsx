...
export default function Home() {
  ...
  const { data: trending, isLoading: loadingTrending } = useGetTrendingGames({
    page_size: 5,
  });
  const { data: newReleases, isLoading: loadingNew } = useGetNewReleases({
    page_size: 10,
  });
  const { data: topRated, isLoading: loadingTop } = useGetTopRatedGames({
    page_size: 10,
  });
        ...
        <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-medium">
              Explore thousands of games, compare requirements, and read reviews
              in the most immersive gaming database.
            </p>
          </motion.div>
          ...
          >
            <form onSubmit={handleSearch} className="relative group">
              ...
              <div className="relative flex items-center bg-card/80 backdrop-blur-xl border border-white/20 rounded-full p-2 shadow-2xl transition-all hover:border-primary/50 focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/20">
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="rounded-full h-12 px-8 text-lg font-bold"
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-2">
              ...
              {["RPG", "Open World", "Multiplayer", "Cyberpunk 2077"].map(
                (term) => (
                  <button
                    key={term}
                    onClick={() =>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-black text-white mb-3">
            Everything You Need to Find Your Game
          </h2>
          <p className="text-muted-foreground max-w-xl mx-auto">
            GamerVerse brings together discovery, compatibility, and community
            in one place.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Natural language search — 'best open world RPGs', 'games like GTA V', 'best horror games'.",
              href: "/search",
              cta: "Search Games",
            },
            {
              ...
              title: "Compare Games",
              desc: "Compare ratings, metacritic scores, genres, platforms, and requirements side by side.",
              href: "/compare",
              cta: "Compare Now",
            },
            {
              ...
              desc: "Enter your CPU, GPU, and RAM to see if you can run any game before downloading.",
              href: "/pc-check",
              cta: "Check My PC",
            },
            {
              ...
              title: "Wishlist",
              desc: "Save games you want to play and build your personal gaming backlog.",
              href: "/wishlist",
              cta: "View Wishlist",
            },
            {
              ...
              desc: "Can't find a game? Submit a request and we'll add it to the platform.",
              href: "/request-game",
              cta: "Submit Request",
            },
            {
              ...
              title: "Request Mod Links",
              desc: "Request mods for your favorite games. Vote on requests and track their status.",
              href: "/request-mod",
              cta: "Request a Mod",
            },
            ...
            >
              <div
                className={`inline-flex p-3 rounded-xl border mb-4 ${color}`}
              >
      ...
      <div className="container mx-auto px-4 pb-12 space-y-24">
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            ...
            <Button
              variant="ghost"
              onClick={() => setLocation("/discover?ordering=-added")}
            >
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            ...
            <Button
              variant="ghost"
              onClick={() => setLocation("/discover?ordering=-released")}
            >
              View All <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
          </div>
        ...
        {featuredCollections && featuredCollections.length > 0 && (
          <section className="space-y-16">
            {featuredCollections.map((collection) => (
              <div
                key={collection.id}
                className="relative rounded-3xl overflow-hidden border border-white/10 bg-card/50"
              >
        ...
        <section>
          <div className="flex items-center justify-between mb-8">
            ...
            <Button
              variant="ghost"
              onClick={() => setLocation("/discover?ordering=-rating")}
            >
              View All <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
          </div>
